...
export const PROJECTS: Project[] = [
  {
    ...
    image: assetPath('images/sagarsociety.jpg'),
    units: 42,
  ...
  },
  {
    ...
    image: assetPath('images/aaijagdamba.jpg'),
    units: 28,
  ...
  },
  {
    ...
    image: assetPath('images/starresidency.jpg'),
    units: 9,
  ...
  },
  {
    ...
    category: ['Living'],
    location: 'Satara',
    image: assetPath('images/aashirwad.jpg'),
    units: 13,
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    image: assetPath('images/maleavatar.png'),
    story: {
  ...
  },
  {
    ...
    name: 'Anita Deshmukh',
    role: 'Business Owner',
    image: assetPath('images/femaleavatar.png'),
    story: {
