      ...
      <section className="py-24 md:py-40 bg-white px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {[
              { title: 'Premium Hardware', desc: 'Solid brass handles designed for weight, durability, and a comfortable grip.', img: '/brasshandles.jpg' },
              { title: 'Durable Windows', desc: 'High-quality aluminum frames designed for silent operation and long-lasting performance.', img: '/window.jpg' },
              { title: 'Smart Lighting', desc: 'Thoughtfully planned internal lighting designed to match your natural daily routine.', img: '/naturallight.jpg' },
            ].map((detail, idx) => (
              <motion.div 
                key={idx} 
